...
from src.eval.export import export_assignments_csv, export_metrics_csv, export_route_waypoints_csv
...
def main() -> None:
    ...
    export_route_waypoints_csv(
        assignment_results,
        output_dir / "planned_routes_waypoints.csv",
        weather_map=scenario.weather_map,
        time=scenario.time,
    )
    ...
    print(
        "exported:",
        {
            ...
            "waypoints": str(output_dir / "planned_routes_waypoints.csv"),
