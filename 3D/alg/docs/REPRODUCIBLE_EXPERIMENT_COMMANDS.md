...
## 9. GPR + Mamba + MAPPO 对齐版本 benchmark
...
```powershell
python examples/run_mappo_benchmark.py --config configs/default.yaml --checkpoint outputs/mappo_trackability_multiseed/track_w25_seed7_e40/best_checkpoint.pt --output-dir outputs/gpr_mamba_mappo_benchmark
```
...
outputs/gpr_mamba_mappo_benchmark/metrics_with_mappo.csv
outputs/gpr_mamba_mappo_benchmark/assignments_reference.csv
outputs/gpr_mamba_mappo_benchmark/planned_routes_waypoints.csv
outputs/gpr_mamba_mappo_benchmark/mpc_tracking.csv
```

其中 `planned_routes_waypoints.csv` 是给 Qt/Web 三维可视化直接读取的完整航迹点文件。
