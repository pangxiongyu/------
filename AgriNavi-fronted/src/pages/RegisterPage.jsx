            ...
            <form onSubmit={handlesubmit} className="space-y-4">
              <div>
                ...
                <div className="relative">
                  ...
                  <input type="text" value={displayname} onChange={e => setdisplayname(e.target.value)} placeholder="请输入昵称" className="input-glow pl-11" autoFocus />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input type="text" value={username} onChange={e => setusername(e.target.value)} placeholder="3-20 位字母或数字" className="input-glow pl-11" />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input type="password" value={password} onChange={e => setpassword(e.target.value)} placeholder="至少 6 位密码" className="input-glow pl-11" />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  <HiLockClosed className="absolute left-3.5 top-1/2 -translate-y-1/2 w-5 h-5 text-gray-400" />
                  <input type="password" value={confirmpassword} onChange={e => setconfirmpassword(e.target.value)} placeholder="再次输入密码" className="input-glow pl-11" />
                </div>
              </div>
              ...
              <button type="submit" className="btn-primary w-full justify-center text-base py-3.5 bg-gradient-to-r from-blue-500 to-blue-700 shadow-glow-blue hover:shadow-glow-blue group">
