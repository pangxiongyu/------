...
export default function HeroBanner() {
  return <section className="relative min-h-screen flex items-center overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute top-1/3 -right-32 w-[400px] h-[400px] bg-agri-300/15 rounded-full blur-[100px] animate-float" style={{
        animationDelay: '1.2s'
      }} />
        <div className="absolute -bottom-20 left-1/4 w-[350px] h-[350px] bg-emerald-200/10 rounded-full blur-[80px] animate-float" style={{
        animationDelay: '2s'
      }} />
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <div className="grid grid-cols-3 gap-3">
              ...
              title: '协同控制',
              desc: '8 机编队协同'
            }].map((f, i) => <div key={f.title} className="group relative bg-white/8 backdrop-blur-md rounded-2xl p-4 border border-white/15 hover:bg-white/15 transition-all duration-300 hover:scale-[1.03] hover:border-white/25 cursor-default">
          ...
          <div className="hidden lg:flex items-center justify-center">
            <div className="relative">
              ...
              <div className="relative w-[440px] h-[440px]">
                ...
                {/* 环绕元素 */}
                <div className="absolute top-[15%] left-[18%] w-10 h-10 bg-white/15 rounded-2xl backdrop-blur-md border border-white/25 flex items-center justify-center animate-float shadow-lg" style={{
                animationDelay: '0.4s'
              }}>
                  <div className="w-3 h-3 rounded-full bg-white/80" />
                </div>
                <div className="absolute top-[10%] right-[20%] w-8 h-8 bg-white/12 rounded-xl backdrop-blur-md border border-white/20 flex items-center justify-center animate-float shadow-lg" style={{
                animationDelay: '1.8s'
              }}>
                  <div className="w-2.5 h-2.5 rounded-full bg-agri-200/80" />
                </div>
                <div className="absolute bottom-[20%] right-[16%] w-12 h-12 bg-white/15 rounded-2xl backdrop-blur-md border border-white/25 flex items-center justify-center animate-float shadow-lg" style={{
                animationDelay: '0.9s'
              }}>
                  <div className="w-3.5 h-3.5 rounded-full bg-white/70" />
                </div>
                <div className="absolute bottom-[22%] left-[20%] w-9 h-9 bg-white/12 rounded-xl backdrop-blur-md border border-white/20 flex items-center justify-center animate-float shadow-lg" style={{
                animationDelay: '2.3s'
              }}>
                ...
                <div className="absolute bottom-[32%] left-[5%] w-3 h-3 -translate-x-1/2 -translate-y-1/2 rounded-full border border-white/20 animate-ring-expand" style={{
                animationDelay: '1s'
              }} />
              </div>
            </div>
