...
export default function TransitionPage() {
  return <PageContainer>
      <div className="min-h-[calc(100vh-4rem)] bg-gradient-to-b from-sky-50 via-blue-50 to-indigo-50 flex items-center justify-center relative overflow-hidden">
        ...
        <div className="absolute bottom-1/3 left-1/4 w-2 h-2 bg-indigo-300/40 rounded-full animate-float" style={{
        animationDelay: '1s'
      }} />
        <div className="absolute top-1/3 left-1/3 w-4 h-4 bg-blue-200/30 rounded-lg rotate-12 animate-float" style={{
        animationDelay: '1.8s'
      }} />
        ...
        ease: 'easeOut'
          ...
          {/* 装饰环 */}
          <div className="absolute -inset-10 border-2 border-blue-200/25 rounded-3xl animate-pulse" style={{
          ...
          <div className="relative bg-white/65 backdrop-blur-xl rounded-3xl border border-white/60 shadow-2xl shadow-blue-200/20 px-16 py-14 text-center">
            ...
            delay: 0.8
              ...
              <Link to="/data-display" className="btn-primary bg-gradient-to-r from-agri-500 to-emerald-600 inline-flex items-center gap-2 shadow-glow-sm hover:shadow-glow group">
                进入功能
...
function DecoCorner({
  ...
  return <svg className={`absolute w-6 h-6 text-blue-300/30 ${classname}`} viewBox="0 0 20 20" fill="none">
