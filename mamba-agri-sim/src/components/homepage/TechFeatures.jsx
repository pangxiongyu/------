...
import { TECH_FEATURES } from '../../data/statsData'
...
export default function TechFeatures() {
  return (
    <section className="py-24 bg-gradient-to-b from-gray-50/80 via-white to-white relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6">
        <SectionTitle
          badge="核心技术"
          title="核心技术能力"
          subtitle="融合前沿 AI 算法与三维可视化技术，构建新一代智慧农业无人机控制平台"
        />
